...
def main():
    ...
    parser.add_argument("--config-file", default="configs/activitynet.yaml", metavar="FILE",
    ...
    print('{:<30}  {:.1f} MB'.format('number of params: ', n_parameters / 1000 ** 2))
    ...
    for dataset_name, data_loader_val in zip(dataset_names, data_loaders_val):
        inference(model, data_loader_val, dataset_name=dataset_name, nms_thresh=cfg.TEST.NMS_THRESH,
                  device=cfg.MODEL.DEVICE, name=dataset_name)
        synchronize()
