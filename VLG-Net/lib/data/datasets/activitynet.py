...
class ActivityNetDataset(torch.utils.data.Dataset):
    ...
    def set_syntactic_relations(self):
        self.relations = {'det': 1, 'case': 2, 'punct': 3, 'nsubj': 4, 'obl': 5, 'obj': 6, 'conj': 7, 'amod': 8,
                          'cc': 9, 'advmod': 10, 'nmod': 11, 'compound': 12, 'mark': 13, 'dep': 14, 'nmod:poss': 15,
                          'xcomp': 16, 'aux:pass': 17,
                          'advcl': 18, 'nsubj:pass': 19, 'aux': 20, 'compound:prt': 21, 'acl': 22, 'nummod': 23,
                          'ccomp': 24, 'cop': 25, 'fixed': 26,
                          'acl:relcl': 27, 'parataxis': 28, 'expl': 29, 'obl:tmod': 30, 'obl:npmod': 31, 'iobj': 32,
                          'det:predet': 33, 'appos': 34,
                          'csubj': 35, 'discourse': 36, 'csubj:pass': 37, 'cc:preconj': 38, 'orphan': 39,
                          'goeswith': 40, 'ROOT': 41}
